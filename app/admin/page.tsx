    ...
    <main className="mx-auto max-w-5xl px-4 py-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <h1 className="font-sans text-3xl font-semibold text-paper">Dashboard</h1>
        </div>
        <Link
          href="/admin/content/new"
          className="font-mono text-xs uppercase text-ink bg-amber rounded-card px-4 py-2 hover:opacity-90"
        >
          + Add content
        </Link>
      </div>
